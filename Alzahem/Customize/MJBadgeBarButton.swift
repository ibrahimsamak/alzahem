...
class MJBadgeBarButton: UIBarButtonItem
{
    ...
    {
        didSet {
            if (self.shouldHideBadgeAtZero == true) || self.badgeValue.isEmpty {
    ...
    func setup(customButton: UIButton) {
        ...
        self.badge.backgroundColor = UIColor(patternImage: UIImage(named: "notif")!)
